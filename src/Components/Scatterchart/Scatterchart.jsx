...
const Scatterchart = () => {
  ...
  const layout = {
    ...
    // bargroupgap: 0.2,
    // barmode: 'overlay',
    title: 'Risk vs Returns for stocks',
    xaxis: { title: 'Risk' },
    yaxis: { title: 'Returns' },
  };
  const layout1 = {
    ...
    // bargroupgap: 0.2,
    // barmode: 'overlay',
    title: 'Risk vs Returns for portfolio and indexes',
    xaxis: { title: 'Risk' },
    yaxis: { title: 'Returns' },
  };
  return (
            ...
            data={[
              {
                ...
                type: 'scatter',
                mode: 'markers',
                marker: { size: 16, color: FullLoc1, colorscale: 'blugrn' },
              },
            ...
            data={[
              {
                ...
                type: 'scatter',
                mode: 'markers',
                marker: { size: 16, color: Full1Loc1, colorscale: 'blugrn' },
              },
              // { type: 'bar', x: [1, 2, 3], y: [2, 5, 3] },
            ]}
            layout={layout1}
